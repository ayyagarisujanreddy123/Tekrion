...
- Declared the traffic-capturing daemon and CLI as dual-use npm packages and
  included package-root disclosures describing their authorized observability
  purpose, sensitive-data boundary, and prohibited misuse.
